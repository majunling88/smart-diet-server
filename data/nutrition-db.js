...
let extendedData = {};
try {
  extendedData = require('./nutrition-extended.js');
} catch (e) {
  console.log('扩展数据文件未找到，使用基础数据');
}
...
function mergeExtendedData() {
  if (!extendedData.stapleFoods) return;
  
  // 合并谷薯类
  extendedData.stapleFoods.forEach(food => {
    if (!NUTRITION_DB[food.name]) {
      NUTRITION_DB[food.name] = {
        ...food,
        sodium: food.sodium || 5,
        cholesterol: food.cholesterol || 0,
        vitaminA: food.vitaminA || 0,
        vitaminC: food.vitaminC || 0,
        calcium: food.calcium || 10,
        iron: food.iron || 1,
        category: '谷薯类',
  ...
  // 合并蔬菜类
  extendedData.vegetableFoods.forEach(food => {
    if (!NUTRITION_DB[food.name]) {
      NUTRITION_DB[food.name] = {
        ...food,
        sodium: food.sodium || 30,
        cholesterol: food.cholesterol || 0,
        vitaminA: food.vitaminA || 50,
        vitaminC: food.vitaminC || 20,
        calcium: food.calcium || 30,
        iron: food.iron || 1,
        category: '蔬菜类',
      };
    }
  ...
  // 合并水果类
  extendedData.fruitFoods.forEach(food => {
    if (!NUTRITION_DB[food.name]) {
      NUTRITION_DB[food.name] = {
        ...food,
        sodium: food.sodium || 3,
        cholesterol: food.cholesterol || 0,
        vitaminA: food.vitaminA || 5,
        vitaminC: food.vitaminC || 10,
        calcium: food.calcium || 8,
        iron: food.iron || 0.3,
        category: '水果类',
        glycemicIndex: food.glycemicIndex || 45,
      };
    }
  });
...
module.exports = {
  ...
  // ==================== 谷薯类扩展 ====================
  '黑麦': { calories: 338, protein: 10.3, carbs: 72.0, fat: 1.6, fiber: 2.8, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 24, iron: 2.6, category: '谷薯类', glycemicIndex: 55 },
  '大麦': { calories: 354, protein: 10.2, carbs: 73.0, fat: 1.4, fiber: 3.9, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 33, iron: 3.0, category: '谷薯类', glycemicIndex: 56 },
  '小麦': { calories: 317, protein: 11.0, carbs: 70.0, fat: 1.3, fiber: 2.7, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 34, iron: 3.5, category: '谷薯类', glycemicIndex: 70 },
  '糯米': { calories: 348, protein: 7.3, carbs: 78.0, fat: 1.0, fiber: 0.8, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 10, iron: 0.8, category: '谷薯类', glycemicIndex: 87 },
  '粳米': { calories: 346, protein: 7.7, carbs: 77.0, fat: 0.8, fiber: 0.6, sodium: 3, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 11, iron: 0.5, category: '谷薯类', glycemicIndex: 83 },
  '籼米': { calories: 347, protein: 7.9, carbs: 77.0, fat: 0.7, fiber: 0.5, sodium: 3, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 10, iron: 0.6, category: '谷薯类', glycemicIndex: 82 },
  '黑米': { calories: 333, protein: 8.5, carbs: 72.0, fat: 2.0, fiber: 2.8, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 12, iron: 1.6, category: '谷薯类', glycemicIndex: 55 },
  '红米': { calories: 349, protein: 7.5, carbs: 76.0, fat: 1.2, fiber: 1.5, sodium: 3, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 8, iron: 1.2, category: '谷薯类', glycemicIndex: 58 },
  '糙米': { calories: 368, protein: 7.4, carbs: 77.0, fat: 2.5, fiber: 2.0, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 14, iron: 1.5, category: '谷薯类', glycemicIndex: 56 },
  '胚芽米': { calories: 360, protein: 8.0, carbs: 76.0, fat: 2.0, fiber: 1.5, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 12, iron: 1.3, category: '谷薯类', glycemicIndex: 60 },
  '麦片': { calories: 367, protein: 12.0, carbs: 68.0, fat: 7.0, fiber: 5.0, sodium: 8, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 45, iron: 4.0, category: '谷薯类', glycemicIndex: 55 },
  '玉米片': { calories: 361, protein: 8.0, carbs: 80.0, fat: 1.2, fiber: 2.5, sodium: 450, cholesterol: 0, vitaminA: 15, vitaminC: 0, calcium: 10, iron: 2.5, category: '谷薯类', glycemicIndex: 81 },
  '玉米面': { calories: 340, protein: 8.5, carbs: 73.0, fat: 1.5, fiber: 2.5, sodium: 5, cholesterol: 0, vitaminA: 10, vitaminC: 0, calcium: 12, iron: 1.8, category: '谷薯类', glycemicIndex: 68 },
  '小米面': { calories: 356, protein: 9.5, carbs: 75.0, fat: 2.0, fiber: 1.8, sodium: 4, cholesterol: 0, vitaminA: 15, vitaminC: 0, calcium: 35, iron: 4.5, category: '谷薯类', glycemicIndex: 71 },
  '荞麦面': { calories: 340, protein: 9.0, carbs: 72.0, fat: 1.5, fiber: 4.0, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 18, iron: 2.8, category: '谷薯类', glycemicIndex: 54 },
  '绿豆面': { calories: 330, protein: 22.0, carbs: 60.0, fat: 1.0, fiber: 5.0, sodium: 3, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 80, iron: 6.5, category: '谷薯类', glycemicIndex: 50 },
  '黄豆面': { calories: 418, protein: 33.0, carbs: 33.0, fat: 18.0, fiber: 8.0, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 200, iron: 8.0, category: '谷薯类', glycemicIndex: 45 },
  '红薯粉': { calories: 337, protein: 2.5, carbs: 84.0, fat: 0.2, fiber: 0.5, sodium: 10, cholesterol: 0, vitaminA: 5, vitaminC: 0, calcium: 15, iron: 0.5, category: '谷薯类', glycemicIndex: 65 },
  '土豆粉': { calories: 341, protein: 3.0, carbs: 85.0, fat: 0.1, fiber: 0.3, sodium: 8, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 10, iron: 0.4, category: '谷薯类', glycemicIndex: 68 },
  '木薯': { calories: 160, protein: 0.9, carbs: 38.0, fat: 0.3, fiber: 1.8, sodium: 14, cholesterol: 0, vitaminA: 0, vitaminC: 20, calcium: 16, iron: 0.3, category: '谷薯类', glycemicIndex: 70 },
  '葛根粉': { calories: 357, protein: 0.5, carbs: 89.0, fat: 0.1, fiber: 0.2, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 8, iron: 0.2, category: '谷薯类', glycemicIndex: 60 },
  '藕粉': { calories: 372, protein: 0.2, carbs: 93.0, fat: 0.1, fiber: 0.1, sodium: 10, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 20, iron: 0.5, category: '谷薯类', glycemicIndex: 65 },
  '西米': { calories: 358, protein: 0.2, carbs: 88.0, fat: 0.2, fiber: 0.1, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 10, iron: 0.1, category: '谷薯类', glycemicIndex: 70 },
  '通心粉': { calories: 350, protein: 12.0, carbs: 72.0, fat: 1.5, fiber: 2.0, sodium: 8, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 20, iron: 2.0, category: '谷薯类', glycemicIndex: 65 },
  '意面': { calories: 350, protein: 12.0, carbs: 72.0, fat: 1.5, fiber: 2.5, sodium: 6, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 18, iron: 1.8, category: '谷薯类', glycemicIndex: 55 },
  '螺旋面': { calories: 350, protein: 12.0, carbs: 72.0, fat: 1.5, fiber: 2.0, sodium: 7, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 16, iron: 1.6, category: '谷薯类', glycemicIndex: 55 },
  '蝴蝶面': { calories: 352, protein: 11.5, carbs: 73.0, fat: 1.3, fiber: 1.8, sodium: 8, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 15, iron: 1.5, category: '谷薯类', glycemicIndex: 56 },
  '乌冬面': { calories: 136, protein: 4.5, carbs: 28.0, fat: 0.5, fiber: 0.5, sodium: 200, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 10, iron: 0.8, category: '谷薯类', glycemicIndex: 70 },
  '荞麦面': { calories: 140, protein: 5.0, carbs: 28.0, fat: 0.8, fiber: 2.0, sodium: 180, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 12, iron: 1.2, category: '谷薯类', glycemicIndex: 54 },
  '冷面': { calories: 110, protein: 3.5, carbs: 24.0, fat: 0.3, fiber: 0.5, sodium: 150, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 8, iron: 0.5, category: '谷薯类', glycemicIndex: 65 },
  '河粉': { calories: 109, protein: 2.5, carbs: 25.0, fat: 0.2, fiber: 0.3, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 5, iron: 0.3, category: '谷薯类', glycemicIndex: 70 },
  '肠粉': { calories: 110, protein: 3.0, carbs: 22.0, fat: 1.5, fiber: 0.3, sodium: 280, cholesterol: 20, vitaminA: 5, vitaminC: 0, calcium: 10, iron: 0.5, category: '谷薯类', glycemicIndex: 68 },
  '陈村粉': { calories: 108, protein: 2.2, carbs: 24.0, fat: 0.2, fiber: 0.2, sodium: 4, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 4, iron: 0.2, category: '谷薯类', glycemicIndex: 70 },
  '濑粉': { calories: 105, protein: 2.0, carbs: 23.0, fat: 0.2, fiber: 0.2, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 5, iron: 0.2, category: '谷薯类', glycemicIndex: 68 },
  '银针粉': { calories: 115, protein: 2.5, carbs: 25.0, fat: 0.3, fiber: 0.3, sodium: 6, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 6, iron: 0.3, category: '谷薯类', glycemicIndex: 67 },
  '老鼠粉': { calories: 112, protein: 2.3, carbs: 24.0, fat: 0.2, fiber: 0.2, sodium: 5, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 5, iron: 0.2, category: '谷薯类', glycemicIndex: 68 },
  '刀削面': { calories: 140, protein: 4.6, carbs: 29.0, fat: 0.8, fiber: 0.6, sodium: 180, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 13, iron: 1.4, category: '谷薯类', glycemicIndex: 77 },
  '猫耳朵': { calories: 145, protein: 4.8, carbs: 30.0, fat: 0.9, fiber: 0.5, sodium: 190, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 14, iron: 1.5, category: '谷薯类', glycemicIndex: 76 },
  '面疙瘩': { calories: 142, protein: 4.5, carbs: 29.0, fat: 0.8, fiber: 0.6, sodium: 170, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 12, iron: 1.3, category: '谷薯类', glycemicIndex: 75 },
  '面片': { calories: 138, protein: 4.3, carbs: 28.0, fat: 0.7, fiber: 0.5, sodium: 160, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 11, iron: 1.2, category: '谷薯类', glycemicIndex: 74 },
  '馄饨皮': { calories: 280, protein: 9.0, carbs: 58.0, fat: 1.5, fiber: 0.8, sodium: 350, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 20, iron: 1.5, category: '谷薯类', glycemicIndex: 70 },
  '饺子皮': { calories: 275, protein: 8.5, carbs: 57.0, fat: 1.2, fiber: 0.7, sodium: 320, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 18, iron: 1.3, category: '谷薯类', glycemicIndex: 70 },
  '春卷皮': { calories: 320, protein: 8.0, carbs: 65.0, fat: 2.0, fiber: 0.5, sodium: 280, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 15, iron: 1.0, category: '谷薯类', glycemicIndex: 72 },
  '烤麸': { calories: 121, protein: 20.4, carbs: 5.0, fat: 0.3, fiber: 0.2, sodium: 230, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 30, iron: 2.7, category: '谷薯类', glycemicIndex: 40 },
  '面筋': { calories: 141, protein: 26.9, carbs: 3.0, fat: 1.2, fiber: 0.3, sodium: 15, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 45, iron: 2.5, category: '谷薯类', glycemicIndex: 35 },
  '油面筋': { calories: 490, protein: 26.9, carbs: 40.0, fat: 25.0, fiber: 0.5, sodium: 20, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 50, iron: 3.0, category: '谷薯类', glycemicIndex: 55 },
  '水面筋': { calories: 141, protein: 26.9, carbs: 3.0, fat: 1.2, fiber: 0.3, sodium: 15, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 45, iron: 2.5, category: '谷薯类', glycemicIndex: 35 },
  '素肠': { calories: 180, protein: 15.0, carbs: 12.0, fat: 8.0, fiber: 0.5, sodium: 350, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 35, iron: 2.0, category: '谷薯类', glycemicIndex: 45 },
  '素鸡': { calories: 192, protein: 16.5, carbs: 4.0, fat: 12.5, fiber: 0.5, sodium: 450, cholesterol: 0, vitaminA: 0, vitaminC: 0, calcium: 319, iron: 5.3, category: '谷薯类', glycemicIndex: 40 },
